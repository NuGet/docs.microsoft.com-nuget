...
keywords: NuGet package dependencies, package references, project files, PackageReference, packages.config, project.json, VS2017, VS 2017, Visual Studio 2017, 2017
#ROBOTS:
#audience:
#ms.devlang:
ms.reviewer:
