...
| [Manage NuGet UI](https://docs.microsoft.com/en-us/visualstudio/mac/nuget-walkthrough) | Visual Studio for Mac | Consumption | Provide an easy-to-use UI for installing and managing packages in .NET projects. |
