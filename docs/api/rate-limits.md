...
> [!Note]
> We recommend using NuGet.org's [V3 search APIs](https://docs.microsoft.com/nuget/api/search-query-service-resource) as it is not rate limited currently. For V1 and V2 search APIs, the following limits apply:
