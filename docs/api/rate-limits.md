...
We recommend you to use NuGet.org's V3 APIs for search that are performant and do not have any limit currently. For V1 and V2 API's the followins limits are in place:
