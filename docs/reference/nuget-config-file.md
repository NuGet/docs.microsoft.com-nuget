...
> [!NOTE]
> When using the CLI, you can express a [`RestoreSources`](../reference/msbuild-targets#restore-properties) argument to override the `<packageSources>` defined in the NuGet.config.
