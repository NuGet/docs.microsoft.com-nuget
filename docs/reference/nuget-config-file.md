...
> [!NOTE]
> When using the CLI, you can express a [`RestoreSources`](../msbuild-targets#restore-properties) argument to override the `<packageSources>` defined in the NuGet.config.
