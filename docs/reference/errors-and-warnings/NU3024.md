...
<pre>Package 'SamplePackage v1.0.0' from source 'http://contoso.com/index.json': The primary signature's timestamp certificate has an unsupported digest algorithm.</pre>
...
<pre>Package 'SamplePackage v1.0.0' from source 'http://contoso.com/index.json': The timestamp certificate has an unsupported digest algorithm. The following algorithms are supported: SHA-2-256, SHA-2-384, SHA-2-512.</pre>
