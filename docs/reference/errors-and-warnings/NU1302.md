...
For more information about why HTTPS is required and how to configure secure package sources in Visual Studio, see [HTTPS everywhere - Secure package sources](../../consume-packages/https-everywhere.md).
