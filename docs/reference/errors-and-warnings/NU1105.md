...
The error could also mean that the project is unloaded, or is not part of the solution or solution filter.
...
* Alternatively, reload the project or add it to the solution.
