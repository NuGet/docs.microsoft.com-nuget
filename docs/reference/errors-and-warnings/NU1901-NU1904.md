...
For recommended actions when your project uses a package with a known vulnerability, and tools that can help, see [the documentation on auditing packages](../../concepts/Auditing-Packages.md).
