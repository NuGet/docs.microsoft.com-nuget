...
- For Azure Artifacts push examples, see [Azure Artifacts' examples](https://docs.microsoft.com/azure/devops/artifacts/nuget/publish?view=azure-devops#examples).
