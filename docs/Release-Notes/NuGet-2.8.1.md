...
[NuGet 2.8 Release Notes](/release-notes/nuget-2.8) | [NuGet 2.8.2 Release Notes](/release-notes/nuget-2.8.2)
...
For more information about the WebMatrix Extension update, see those specific [release notes](/release-notes/nuget-2.6.1-for-WebMatrix).
