...
For a full list of work items fixed in NuGet 1.4, please view the [NuGet Issue Tracker for this release](https://blog.nuget.org/workitem/list/advanced?keyword=&status=All&type=All&priority=All&release=NuGet%201.4&assignedTo=All&component=All&sortField=LastUpdatedDate&sortDirection=Descending&page=0).

## Bug fixes worth noting:

* [Issue 603](https://blog.nuget.org/workitem/603): Package dependencies across different repositories resolves
correctly when specifying a specific package source.
* [Issue 1036](https://blog.nuget.org/workitem/1036): Adding `NuGet Pack SomeProject.csproj` to post-build event no longer causes an infinite loop.
* [Issue 961](https://blog.nuget.org/workitem/961): `-Source` flag supports relative paths.
...
### Bug Fixes
* [Issue 1220](https://blog.nuget.org/workitem/1220): Update-Package doesnt execute `install.ps1`/`uninstall.ps1` in all projects when there is more than one project
* [Issue 1156](https://blog.nuget.org/workitem/1156): Package Manager Consol stuck on W2K3/XP (when Powershell 2 is not installed)
