...
1. Visual Studio 2015. Install the Community edition for free from [visualstudio.com](https://www.visualstudio.com/); you can use the Professional and Enterprise editions as well.
...
This creates a NuGet package file like `AppLogger.1.0.0.0.nupkg` using the package name and version number from the `.nuspec` file.
